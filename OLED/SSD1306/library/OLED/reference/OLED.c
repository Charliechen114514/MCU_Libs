...
//	HAL_GPIO_WritePin(GPIOB, PB8_Pin, BitValue);
//	
...
//	
	for (i = 0; i < Count; i ++)
	{
		 HAL_I2C_Mem_Write(&hi2c1,0X78,0X40,I2C_MEMADD_SIZE_8BIT,&Data[i],1,0x100);	//依次发送Data的每一个数据
	}
